                ...
                <div className="w-80% m-8 my-10 h-80 grid gap-8 lg:grid-cols-3  md:grid-cols-2  sm:grid-cols-1 ">
                    {
                        courses.map(course =>
                            ...
                            <Link  key={course.id} class="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800
                                ...
                                <div class="px-5 pb-5">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <Link  to={course.id} href="#dfgklhdfg" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none 
